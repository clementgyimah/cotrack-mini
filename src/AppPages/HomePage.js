                        ...
                        <div>
                            ...
                            <div className="verification-body">
                                <div className="verification-input-div">
                                    <input className="verification-input" type={activatePassword ? "password": "text"}
                                        placeholder="Type the verification key" onChange={verificationInputMonitor} value={verificationKey} />
                                </div>
                                <div className="hint-text"><strong>Hint:</strong> Don't you have a key? Get in touch with us on <strong>clementgyimah2@gmail.com</strong> or <strong>+233559505063</strong></div>
                                <span className="activate-password-toggle-span" onClick={() => activatePasswordFunc()}>{activatePassword ? <BsToggleOff className="activate-password-toggle-off" size={20} color="#387C44" /> : <BsToggleOn className="activate-password-toggle-on" size={20} color="#387C44" />} <span className="show-key-text">Show Key</span></span>
                                <div className="verification-button-div">
                                    <div className="verification-button" onClick={() => verifyKey()}>Verify</div>
                                </div>
                                {
                                    keyError ?
                                        (<div className="start-view-error">Oops! <span role="img" aria-label="Thinking">🤔</span>Incorrect key</div>)
                                        :
                                        (<div></div>)
                                }
                            </div>
