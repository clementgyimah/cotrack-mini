    ...
    return (
        <div className="about-container">
            ...
            <div className="buttons-main-div">
                <div className="buttons-div"><span className="check-update-button" onClick={() => openUpdates()}>Check for updates</span></div>
                <div className="buttons-div"><span className="close-about-button" onClick={() => closeAboutWindow()}>Close</span></div>
            </div>
        </div>
    );
}