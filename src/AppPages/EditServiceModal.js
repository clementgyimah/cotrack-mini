...
export default function EditAttendeeModal(props) {
    ...
    }, [props.cDate, props.cStartTime, props.cEndTime, props.cAttendeeNumner, props.cMale, props.cFemale, showEditModal])
        ...
        <div className={showEditModal}>
            <div className="modal-main">
                ...
                <div className="attendee-info-div">
                    ...
                    <div className="details-div"><label htmlFor="service-label-for-number" className="label-span">Males: </label><span id="service-label-for-number" className="detail-span">{editMale}</span></div>
                    <div className="details-div"><label htmlFor="service-label-for-number" className="label-span">Females: </label><span id="service-label-for-number" className="detail-span">{editFemale}</span></div>
