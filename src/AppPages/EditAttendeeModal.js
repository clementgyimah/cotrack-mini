...
export default function EditAttendeeModal(props) {
  ...
  const handleEditDetails = () => {
    if (
      ...
      editContactNumber.length === 0 ||
      editEmailAddress.length === 0
    ) {
      ...
      <div className="modal-main">
        ...
        <div className="attendee-info-div">
          <div className="details-div">
            ...
            <input
              type="text"
              id="attendee-label-for-firstName"
              className="edit-attendee-input-text"
              placeholder="First Name"
              value={editFirstName}
              onChange={editFirstNameFunc}
            />
          </div>
          <div className="details-div">
            ...
            <input
              type="text"
              id="attendee-label-for-lastName"
              className="edit-attendee-input-text"
              placeholder="Last Name"
              value={editLastName}
              onChange={editLastNameFunc}
            />
          </div>
          <div className="details-div">
            <label htmlFor="attendee-label-for-gender" className="label-span">
              Gender:{" "}
            </label>
            <select
              id="attendee-label-for-gender"
              className="edit-attendee-input-text"
              placeholder="Gender"
              value={editGender}
              onChange={editGenderFunc}
            >
          ...
          <div className="details-div">
            ...
            <input
              type="text"
              id="attendee-label-for-location"
              className="edit-attendee-input-text"
              placeholder="Location"
              value={editLocation}
              onChange={editLocationFunc}
            />
          </div>
          <div className="details-div">
            ...
            <input
              type="text"
              id="attendee-label-for-contact"
              className="edit-attendee-input-text"
              placeholder="Contact Number"
              value={editContactNumber}
              onChange={editContactNumberFunc}
            />
          </div>
          <div className="details-div">
            ...
            <input
              type="text"
              id="attendee-label-for-email"
              className="edit-attendee-input-text"
              placeholder="Email Address"
              value={editEmailAddress}
              onChange={editEmailAddressFunc}
            />
          </div>
        </div>
