...
ipcRenderer.on("pdf-printed", async (event, arg) => {
  return alert(
    "😁 PDF Downloaded!!!\n\nCheck " +
      "the path below on your computer file system:\n" +
      arg
  );
});
...
export default function SessionInfo() {
  ...
  return (
    <div className="session-info-container">
      <div className="session-info-header">Date: {dateHolder}</div>
      <div className="session-info-body">
        {sessionHolder.length !== 0 ? (
          <div>
            ...
            <div className="time-div">
              <div className="view-time-div">
                Start Time: {timeHolder.start}
              </div>
                ...
                <table className="session-info-table" rules="all">
                  <thead className="session-info-table-thread">
                    <tr className="session-info-table-thread-tr">
                      <th
                        className="session-info-table-thread-tr-th"
                        scope="col"
                      >
                        <div className="session-table-cells-div">
                          First Name
                        </div>
                      </th>
                      <th
                        ...
                        scope="col"
                      >
                        <div className="session-table-cells-div">Last Name</div>
                      </th>
                      <th
                        className="session-info-table-thread-tr-th"
                        scope="col"
                      >
                        <div className="session-table-cells-div">Gender</div>
                      </th>
                      <th
                        className="session-info-table-thread-tr-th"
                        scope="col"
                      >
                        <div className="session-table-cells-div">Location</div>
                      </th>
                      <th
                        className="session-info-table-thread-tr-th"
                        scope="col"
                  ...
                  <tbody>
                    {sessionHolder ? (
                      sessionHolder.map((newHolderAttendee) => {
                        return (
                          <tr
                            className="session-info-table-tbody-tr"
                            key={
                              newHolderAttendee.firstName +
                              newHolderAttendee.lastName +
                              newHolderAttendee.gender +
                              newHolderAttendee.location +
                              newHolderAttendee.contactNumber +
                              newHolderAttendee.emailAddress +
                              newHolderAttendee.temperature
                            }
                          >
                            <td className="session-info-table-tbody-tr-td">
                              <div className="session-table-cells-div">
                                {newHolderAttendee.firstName}
                              </div>
                            </td>
          ...
          <div className="no-sessions-found-div">
            {/**
             * error to return when no session is recorded
             * for the date whose information is being searched
             */}
            <div className="no-sessions-found-text">
              {" "}
              <span role="img" aria-label="EyesDown">
                😔
              </span>{" "}
              Sorry, there wasn&apos;t any recorded sessions on this date
            </div>
          </div>
        )}
      </div>
